...
<body>
	...
	<div class="container">
		<h2 align="center"> <?php echo $credito[0]->CREDITO;  ?> <i class="fa fa-cc-mastercard" aria-hidden="true"></i></h2>
		<br>
		<div class="">
			...
			<div class="col-md-8">
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
						<input type="number" class="form-control" name="FECHA_VEN" id="FECHA_VEN" maxlength="2" value="<?php echo $credito[0]->FECHA_VEN;  ?>">
						</div>
					</div>   
					<div class="form-group">
